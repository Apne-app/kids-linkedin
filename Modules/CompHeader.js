...
const CompHeader = () => {
    return (<Header style={{ backgroundColor: 'white', height: 80 }}>
        <Left>
            <TouchableOpacity><Icon type="Feather" name="x" style={{ color: "#000", fontSize: 30, marginTop: 30 }} /></TouchableOpacity>
        </Left>
        <Body>
        </Body>
        <Right />
