...
const CompHeader = (props) => {
    ...
    return (<Appbar.Header style={{ backgroundColor: '#327FEB', marginBottom: 10, marginTop: 0, elevation: 10, position: 'absolute', top: 0, left: 0, right: 0, height: 80, }} statusBarHeight={10}>
