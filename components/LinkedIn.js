...
const LinkedIn = ({ navigation, authtoken, loaderHandler }) => {
  ...
  return (
    <LinkedInModal
      ...
      renderButton={() =>
      (
        <Button block iconLeft style={{ marginTop: 28, flex: 1, borderColor: '#327FEB', backgroundColor: '#327FEB', borderWidth: 1, borderRadius: 28.5, height: 50, marginHorizontal: 20, borderBottomColor: '#2477ed', borderBottomWidth: 2 }} onPress={() => linkedRef.current && linkedRef.current.open()} >
