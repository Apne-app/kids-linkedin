        ...
        <Header noShadow style={{ backgroundColor: '#fff', flexDirection: 'row', height: 60, borderBottomWidth: 0, marginTop: 5 }}>
            ...
            >
                ...
                <View style={{ marginTop: 30, flexDirection: 'row' }}>
                    ...
                    <View style={{ flexDirection: 'column', marginLeft: 30, marginTop: 31, flex: 1}}>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={{ fontFamily: 'Poppins-SemiBold', fontSize: 20 }}>{children['0']['data']['name']}</Text>
                            <Icon style={{ fontSize: 15, marginTop: 8, marginLeft: 10 }} name="log-out" type="Feather" />
                        </View>
                        <View style={{ flex: 1,flexWrap: 'wrap', width: "100%", flexDirection: 'row' }}>  
                        <Text style={{ fontFamily: 'Poppins-Regular', color: 'black'}}>I am a very good boy. I am not a bad boy.</Text>
                        </View>
                    </View>
                </View>
