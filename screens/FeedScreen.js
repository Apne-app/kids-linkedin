        ...
        const footer = (id, data) => {
            return (<View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    <LikeButton  {...props} />
                    <Icon onPress={() => props.navigation.navigate('SinglePost', { activity: props, token: children['0']['data']['gsToken'] })} name="message-circle" type="Feather" style={{ fontSize: 22, marginLeft: 10, marginRight: -10 }} />
                    <ReactionIcon
                        labelSingle=" "
                        labelPlural=" "
                        ...
                        onPress={async () => {
                            ...
                            console.log(id); navigation.navigate('SinglePost', { activity: props, token: children['0']['data']['gsToken'] })
                        }}
                    />
                    <Icon onPress={() => {
            ...
            <Activity
                ...
                Content={
                    <View style={{ padding: 14 }}>
                        <TouchableWithoutFeedback onPress={() => navigation.navigate('SinglePost', { token: children['0']['data']['gsToken'], activity: props })}>
                    ...
                    <View style={{ padding: 14 }}>
                        ...
                        {/* {props.activity.youtube ?
                            <YouTube
                                ...
                                style={{ borderRadius: 10, width: width - 80, height: 340, }}
                            /> : null} */}
                        {props.activity.tag === 'Genio' || props.activity.tag === 'Other' ? null : <Chip style={{ fontFamily: 'NunitoSans-SemiBold', fontSize: 13, backgroundColor: 'white', color: '#327FEB', textAlign: 'center', borderRadius: 28.5, borderColor: '#327FEB', borderWidth: 1, paddingHorizontal: 10 }} textStyle={{ color: "#327FEB", fontFamily: 'NunitoSans-Regular' }} >{props.activity.tag}</Chip>
                        }
                    </View>
                }
                Footer={footer(props.activity.id, props)}
