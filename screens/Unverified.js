    ...
    return (
        <View style={{ backgroundColor: 'white', height: height, width: width }}>
            ...
            <View style={{ backgroundColor: 'white' }}>
                <Button onPressIn={() => send()} block dark style={{ marginTop: 30, backgroundColor: '#91d7ff', borderRadius: 10, height: 50, width: width - 40, alignSelf: 'center', marginHorizontal: 20 }}>
                    <Text style={{ color: "black", fontFamily: 'Poppins-SemiBold', fontSize: 16, marginTop: 2 }}>Send again</Text>
                </Button>
                <Button onPressIn={() => navigation.navigate('Home')} block dark style={{ marginTop: 10, backgroundColor: 'lightgreen', borderRadius: 10, height: 50, width: width - 40, alignSelf: 'center', marginBottom: 40, marginHorizontal: 20 }}>
