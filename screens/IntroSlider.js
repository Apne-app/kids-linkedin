...
export default class App extends React.Component {
  ...
  _renderDoneButton = () => {
    return (
      <TouchableOpacity onPress={() => this.props.navigation.navigate('Login', {'back':'IntroSlider'})} block dark style={{ backgroundColor: '#fff', borderRadius: 30, width: width*0.86, alignSelf: 'center', marginBottom: 40, marginHorizontal: 20 }}>
